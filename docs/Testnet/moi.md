...
id: Moi
title: MOI
sidebar_label: MOI Recommend 
sidebar_position: 1
icon: /docs/static/img/fire.png
---
...
{props.IP_or_Domain}: đây là địa chỉ IP WAN để kết nối ra bên ngoài, có thể thay thế bằng địa chỉ ddns. Khuyến khích dùng dịch vụ [NoIP](https://www.noip.com/).
